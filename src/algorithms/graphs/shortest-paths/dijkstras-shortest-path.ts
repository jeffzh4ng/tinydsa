...
export type WeightedGraph<T> = Map<GraphNode<T>, Map<GraphNode<T>, number>>
...
type ShortestDistances<T> = Map<GraphNode<T>, number>
type PrevVertices<T> = Map<GraphNode<T>, GraphNode<T> | null>
